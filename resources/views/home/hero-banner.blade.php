      ...
      <div class="col-lg-6">
        <div class="hero-content">
          <h1 class="main-heading">
            {!! $site_settings->hero_title ?? 'Welcome to <span class="theme">' . $site_settings->site_name . '</span>' !!}
          </h1>
          <p>
      ...
      <div class="col-lg-6">
        <div class="hero-slider">
          ...
          @empty
            ...
            <div>
              <img
                src="https://images.unsplash.com/photo-1606761568499-6d2451b23c66?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Library">
            </div>
            <div>
              <img
                src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Students">
            </div>
          @endforelse
        </div>
